...
def test_create_user():
    ...
    "full_name": "Test User", "password": "password333"},
    )
    assert response.status_code == 200
    data = response.json()
...
def test_successful_authentication():
    ...
    data = {"grant_type": "password","username": "testuser","password": "password333"}
...
def test_incorrect_username_password():
    ...
    data2 = {"grant_type": "password","username333": "testuser","password": "password333222"}
